...
(() => {
  // src/client/app.ts
  var gallery = getRequiredElement("gallery");
  var statusBox = getRequiredElement("status");
  var rescanButton = getRequiredElement("rescanButton");
  var modal = getRequiredElement("playerModal");
  var closeButton = getRequiredElement("closeButton");
  var player = getRequiredElement("player");
  var playerTitle = getRequiredElement("playerTitle");
  var playerMeta = getRequiredElement("playerMeta");
  ...
  function renderGallery(items) {
    ...
    <article class="card">
      <div class="poster">
        ${item.thumbnailUrl ? `<img src="${item.thumbnailUrl}" alt="${escapeHtml(item.filename)}" loading="lazy" />` : '<div class="poster-placeholder">No thumbnail</div>'}
      </div>
